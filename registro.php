...
<script type="text/javascript" src="js/html5.js"></script><script type="text/javascript" src="js/modernizr-latest.js"></script>
...
<?php 
    require_once("class/Control.Menu.php"); $obj_funciones = new cls_funciones ; $result= $obj_funciones->f_Menu_Sistema($id_user);
